...
# function called mult_list() to multiply all the numbers.
...
def mult_list(lst):
  ...
  #mulitply list elements together 
  if len(lst) > 1:
    for i in lst[1:]:
      prod = prod * i
...
# function called num_within() checking that a number falls in a given range.
